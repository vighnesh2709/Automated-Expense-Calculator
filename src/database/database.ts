...
export async function insertData(bankAccountNumber: string, transactionDate: number, transactionAmount: number, transactionTo: string, debitedCredited: string) {
    ...
    const reply = await pool.query(`
      ...
      VALUES (${bankAccountNumber}, ${transactionDate}, ${transactionAmount}, ${debitedCredited}, ${transactionTo})
    `);
